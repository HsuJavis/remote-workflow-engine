...
// no import outside this directory" (TASK-207's own DoD grep, `Date\.now()\|new Date()` over
// `src/dashboard/lib`, tripped on the old location). `ui/` is the layer ARCH-125 allows I/O in — the
// seam itself is unchanged, only which directory owns it.
//
