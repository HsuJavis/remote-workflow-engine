...
// 2026-09-26 (alias mechanism removed): the model-ref rule is now static text (`modelRefSentence()`
// inside `buildAuthoringGuide`) — there is no per-deployment alias table to interpolate any more.
const text = buildAuthoringGuide({ ...DEFAULT_CEILINGS, runConcurrency: DEFAULT_RUN_CONCURRENCY });
