// IT-009: McpFacade.run_agent_log returns the actual persisted transcript events of a
...
//
// Red reason (2026-07-03, before Gate 6 rework): `src/mcp-facade.ts` run_agent_log
...
describe('run_agent_log real transcript read-back (IT-009, D-V6)', () => {
