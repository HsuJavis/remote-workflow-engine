...
- workflow_publish: fail — args={"name":"demo","version":1} observed={"runId":"","status":"failed","code":"CatalogNotFoundError","error":{"code":"CatalogNotFoundError","message":"Workflow not found in catalog: demo"}}
