...
**[v27b] Nothing in this delta adopts a new seam, and nothing in it reads a clock, a random source or a
...
healthy run renders nothing either. VAL-199/VAL-204 may not be judged before TASK-201's `label` has landed,
