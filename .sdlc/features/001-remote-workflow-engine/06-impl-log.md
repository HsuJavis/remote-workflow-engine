...
### IMPL-122 — auth route wiring: resolvePrincipal + 5 OAuth routes + auth gates on /mcp, /assets/blob/:sha, /assets/manifest; v16: isLoopbackRedirectUri + gcExpired sweep wiring; v17: RFC 7591 DCR (TASK-086, TASK-090, TASK-091); v18: 3 distinct Google URL fields (TASK-092)
- **status:** done
- **traces:** TASK-086, TASK-090, TASK-091, TASK-092, DES-092, DES-093, DES-094, DES-095
- **greens:** UT-095, UT-094 (v18 new cases: IT-078 spy + GOOGLE_*_URL static pin), IT-078 (cases 1-7, 8a-8f, 9a-9c, 10, 11-18, 19-20), IT-079 (regression), VAL-095 (cases 1-7d)
